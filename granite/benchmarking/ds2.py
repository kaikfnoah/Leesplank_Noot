...
df_0 = df[int(df_size*(1/3)):int(df_size*(2/3))]
...
print(f"Starting benchmarking on dataset 2 (size: {len(df_0)})")
...
for row_idx, row in tqdm(df_0.iterrows()):
    ...
    print(f"Finished dataset 2 in {elapsed_time_data:.2f} seconds")
